...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "terminal", "internet", "file manager", "media", "chat" }
    local layouts = {
        awful.layout.layouts[2], -- floating
        awful.layout.layouts[3], -- tile
        awful.layout.layouts[2], -- tile
        awful.layout.layouts[2], -- tile
        awful.layout.layouts[2], -- max
}
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "Pause",
        function()
            awful.spawn.with_shell("sudo /usr/bin/systemctl poweroff")
  end,
